...
/**
 * Created by theostanton on 05/01/16.
 * copied MvpActivity to retain BaseACtivity functionality
 */
public abstract class MVPBaseActivity<V extends MvpView, P extends MvpPresenter<V>> extends BaseActivity implements ActivityMvpDelegateCallback<V, P>, MvpView {
